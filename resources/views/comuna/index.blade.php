    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                 ...
                 *   - `comu_codi`: Código único de la comuna.
                 *   - `comu_nomb`: Nombre de la comuna.
                 *   - `muni_nomb`: Nombre del municipio asociado a la comuna.
                 * - La última celda de cada fila contiene un marcador de "Acciones".
                 * 
                 * Notas:
